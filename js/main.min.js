...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var menu = function menu() {
    ...
    if (navigation) {
      var closeMenu = function closeMenu() {
        ...
        var cards = document.querySelectorAll('.hero__tour');
      ...
      var openMenu = function openMenu() {
        ...
        var cards = document.querySelectorAll('.hero__tour--padding');
        cards.forEach(function (element) {
  ...
  window.addEventListener('load', function () {
    ...
    var addPadding = function addPadding() {
      var card = document.querySelector('.tour-card');
      if (card.classList.contains('hero__tour--padding')) {
        var phonesWrapper = document.querySelector('.header__phones-wrapper');
        var phones = phonesWrapper.children;
        var cards = document.querySelectorAll('.hero__tour--padding.tour-card');
        var mobile = window.matchMedia('(min-width: 320px) and (max-width: 1199px)');
        if (mobile && phones.length > 1) {
          var heightWrapper = phonesWrapper.clientHeight;
          var heightPhone = phones[0].clientHeight;
          cards.forEach(function (element) {
